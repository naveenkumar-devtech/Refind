...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'lostfound.utils.custom_exception_handler' if os.path.exists(os.path.join(BASE_DIR, 'utils.py')) else 'rest_framework.views.exception_handler',
}
