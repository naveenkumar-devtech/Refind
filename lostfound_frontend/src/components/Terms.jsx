          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center">
              <nav className="hidden sm:flex items-center space-x-4 sm:space-x-6 md:space-x-8 ml-4 sm:ml-6 whitespace-nowrap">
                ...
                <Link to="/privacy" className="relative group hover:text-cyan-400 transition-all duration-300 text-sm sm:text-base">
                  Privacy
                  <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-500 group-hover:w-full transition-all duration-300" />
                </Link>
          ...
          <div className="max-w-3xl sm:max-w-4xl mx-auto">
            <div className={`text-center mb-12 sm:mb-16 transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="inline-flex items-center space-x-2 sm:space-x-3 bg-gradient-to-r from-cyan-500/10 to-purple-600/10 border border-cyan-500/30 rounded-full px-4 sm:px-6 py-2 sm:py-3 backdrop-blur-xl">
                ...
                <span className="text-cyan-300 font-medium text-sm sm:text-base">Your Agreement with Refind</span>
            ...
            <div className={`space-y-8 sm:space-y-10 transform transition-all duration-1000 delay-200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <section className="group bg-gradient-to-br from-slate-800/40 to-purple-900/20 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-purple-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-md hover:shadow-purple-500/20">
                <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-cyan-300 transition-colors">Acceptance of Terms</h2>
                <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors text-sm sm:text-base">
                  By using Refind, you agree to these Terms of Service. If you do not agree, please refrain from using our platform.
                </p>
              </section>
              <section className="group bg-gradient-to-br from-slate-800/40 to-purple-900/20 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-purple-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-md hover:shadow-purple-500/20">
                <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-cyan-300 transition-colors">Use of Platform</h2>
                <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors text-sm sm:text-base">
                  You may use Refind to report lost or found items and connect with others. You agree not to:
                </p>
              ...
              <section className="group bg-gradient-to-br from-slate-800/40 to-purple-900/20 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-purple-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-md hover:shadow-purple-500/20">
                <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-cyan-300 transition-colors">User Responsibilities</h2>
                <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors text-sm sm:text-base">
                  You are responsible for the accuracy of your submissions and maintaining your account’s security.
                </p>
              </section>
              <section className="group bg-gradient-to-br from-slate-800/40 to-purple-900/20 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-purple-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-md hover:shadow-purple-500/20">
                <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-cyan-300 transition-colors">Limitation of Liability</h2>
                <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors text-sm sm:text-base">
                  Refind is not liable for losses or damages from platform use, including failed recoveries or external data breaches.
                </p>
              </section>
              <section className="group bg-gradient-to-br from-slate-800/40 to-purple-900/20 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-purple-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-md hover:shadow-purple-500/20">
                <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-white group-hover:text-cyan-300 transition-colors">Changes to Terms</h2>
                <p className="text-gray-300 leading-relaxed group-hover:text-gray-200 transition-colors text-sm sm:text-base">
          ...
          <div className="flex flex-col items-center justify-between space-y-6 sm:space-y-8 md:flex-row md:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                ...
                <span className="text-xs sm:text-sm text-gray-400">Powered by AI • Trusted by 25K+ users</span>
              </div>
            </div>
